...
# messages for step 4
umessage4 = """
1) Analyze the following memory tags provided by the analysis of a text
...
4) Focus on the topic provided that begins with the term the topic you find in the input that follows the original content
"""
utarget4="find the topic in this input and use the memory tags provided"
utarget4b="the sentiment score is negative. Find ways to expand the topic to make improve the service and address a personal message"
