...
# Global output widget for Markdown
...
def summarize_conversation(file_path):
    ...
    Returns:
        None: The summary is displayed in the markdown_output widget.
    """
    ...
    # Step 5: Display the task response in Markdown output widget
    with markdown_output:
        markdown_output.clear_output(wait=True)  # Clear previous content in the widget
